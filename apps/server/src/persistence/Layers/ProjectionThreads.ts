...
import { ModelSelection, ThreadLinkedPullRequest, ThreadSpawnMetadata } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.branch},
          ${row.worktreePath},
          ${row.spawn === undefined || row.spawn === null ? null : JSON.stringify(row.spawn)},
